...
public class SlopeRender implements ISimpleBlockRenderingHandler {
	...
	private boolean render(RoadSlope rBlock, int x, int y, int z, int metadata, Icon sideIcon, Icon topIcon) {
		...
		int direction = (metadata >> 2) & 3; // &3 in case of weirdness
							// - shouldn't happen,
							// but...eh?
		...
		coords[][] squares = new coords[][] {
				{ // front
						...
						new coords(x, direction == 2 ? coordHighHeight
								: coordLowHeight, z, iconMinX, direction == 2 ? iconHighHeight
								: iconLowHeight),
						new coords(x + 1, direction == 2 ? coordHighHeight
								: coordLowHeight, z, iconMaxX, direction == 2 ? iconHighHeight
								: iconLowHeight),
						null }, { // left
						new coords(x, y, z, iconMaxX, iconMinY),
						new coords(x, y, z + 1, iconMinX, iconMinY),
						new coords(x, direction == 3 ? coordHighHeight
								: coordLowHeight, z + 1, iconMinX, direction == 3 ? iconHighHeight
								: iconLowHeight),
						new coords(x, direction == 3 ? coordHighHeight
								: coordLowHeight, z, iconMaxX, direction == 3 ? iconHighHeight
								: iconLowHeight),
						null }, { // back
						new coords(x, y, z + 1, iconMaxX, iconMinY),
						new coords(x + 1, y, z + 1, iconMinX, iconMinY),
						new coords(x + 1, direction == 0 ? coordHighHeight
								: coordLowHeight, z + 1, iconMinX, direction == 0 ? iconHighHeight
								: iconLowHeight),
						new coords(x, direction == 0 ? coordHighHeight
								: coordLowHeight, z + 1, iconMaxX, direction == 0 ? iconHighHeight
								: iconLowHeight),
						null }, { // right
						new coords(x + 1, y, z + 1, iconMaxX, iconMinY),
						new coords(x + 1, y, z, iconMinX, iconMinY),
						new coords(x + 1, direction == 1 ? coordHighHeight
								: coordLowHeight, z, iconMinX, direction == 1 ? iconHighHeight
								: iconLowHeight),
						new coords(x + 1, direction == 1 ? coordHighHeight
								: coordLowHeight, z + 1, iconMaxX, direction == 1 ? iconHighHeight
								: iconLowHeight),
						null }, { // bottom
						new coords(x + 1, y, z + 1, iconMaxX, iconMinY),
						new coords(x, y, z + 1, iconMinX, iconMinY),
