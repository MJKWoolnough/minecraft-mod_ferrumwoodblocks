...
public class RoadSteps extends BlockStairs {
	...
	public RoadSteps(int blockId) {
		...
		this.setLightOpacity(0).setResistance(10).setHardness(1.5F).setStepSound(Block.soundStoneFootstep).setTextureName(ModFerrumwoodBlocks.getModId() + ":roadslab").setUnlocalizedName("roadStep");
	}
