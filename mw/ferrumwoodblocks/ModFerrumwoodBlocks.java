...
public class ModFerrumwoodBlocks {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		int lightId = Config.get("BlockIds", "LightBlock", 4009).getInt();
		int darkId = Config.get("BlockIds", "DarkBlock", 4010).getInt();
		...
		GameRegistry.registerBlock(new LightBlock(lightId), BlockItem.class, "lightBlock");
		GameRegistry.registerBlock(new DarkBlock(darkId), BlockItem.class, "darkBlock");
		...
		}).setStepSound(Block.soundMetalFootstep).setCreativeTab(CreativeTabs.tabTransport).setUnlocalizedName("railPiece");
		...
		}).setStepSound(Block.soundStoneFootstep).setCreativeTab(CreativeTabs.tabDecorations).setUnlocalizedName("railBlock");
