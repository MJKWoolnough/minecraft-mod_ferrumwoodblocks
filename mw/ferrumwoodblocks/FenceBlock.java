...
public class FenceBlock extends BlockFence implements MultiTextureRender.TextureRenderer {
	...
	public final static String[]	textures		= new String[] {
			"planks_oak", "planks_spruce", "planks_birch",
			"planks_jungle", "log_oak", "log_spruce", "log_birch",
			"log_jungle", "stone", "cobblestone",
			"sandstone_normal", "iron_block", "brick", "obsidian",
			"stonebrick", "coal_block"		};

	public FenceBlock(int blockId) {
		super(blockId, "", Material.wood);
		this.setUnlocalizedName("fence").setHardness(2.0F).setResistance(5.0F).setStepSound(soundWoodFootstep);
	}
