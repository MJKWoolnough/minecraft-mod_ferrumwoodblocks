...
public class RoadSlab extends Block {
	...
	public RoadSlab(int blockId, boolean first) {
		...
		this.setLightOpacity(0).setResistance(10).setHardness(1.5F).setStepSound(Block.soundStoneFootstep).setTextureName(ModFerrumwoodBlocks.getModId() + ":roadslab").setCreativeTab(CreativeTabs.tabDecorations).setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 0.5F, 1.0F);
		if (first) {
